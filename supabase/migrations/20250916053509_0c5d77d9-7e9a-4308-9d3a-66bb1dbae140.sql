-- Add lab_number column to cases table
ALTER TABLE public.cases 
ADD COLUMN lab_number VARCHAR UNIQUE;

-- Create index for better performance on lab_number searches
CREATE INDEX idx_cases_lab_number ON public.cases(lab_number);

-- Create function to generate case lab numbers
